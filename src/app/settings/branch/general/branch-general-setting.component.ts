...
@Component({
    selector: 'app-company-general-setting',
...
export class BranchGeneralSettingComponent implements OnInit, AfterViewInit {
     ...
     * Edit dialog launch
     */
    editDialog(company: BranchModel) {
     ...
     * @param company
     */
    openConfirmationDialog(company: BranchModel) {
     ...
     * @param company
     */
    delete(company: BranchModel) {
        this.loader = true;
        this.service.delete(company)
            .subscribe((data) => {
                    this.loader = false;
                    this.loadData();
                    this.notification.showNotification('success', 'Success !! Company has been deleted.');
                },
                (error) => {
                    this.loader = false;
